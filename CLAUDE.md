...
- 440/440 tests must pass before any commit (count updates each session)
...
- Restart: `rm -f bot.pid && source venv/bin/activate && echo "CONFIRM" | nohup python main.py --live >> /tmp/polybot_session20.log 2>&1 &`
