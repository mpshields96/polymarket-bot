"""
Bayesian settlement helper — wires BayesianDriftModel updates into the
settlement loop after each live drift bet settles.
...
# Strategy names that feed the Bayesian drift posterior.
...
def apply_bayesian_update(drift_model, trade: dict, won: bool) -> None:
    """
    Update the Bayesian drift posterior after a settled live drift bet.
