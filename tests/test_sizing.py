...
class TestExistingBehaviorPreserved(unittest.TestCase):
    ...
    def test_expiry_sniper_loop_max_loss_formula(self):
        ...
        At bankroll=208, MAX_PCT=0.08: pct_max=16.63. HARD_CAP=35 (S142). MAX_LOSS=7.50.
        Correct result: 7.50 (DEFAULT_MAX_LOSS governs). Wrong (pre-fix) result: 16.63."""
        ...
        self.assertGreater(wrong, DEFAULT_MAX_LOSS_USD,
